...
class TestProcessBooking(TestCase):
    ...
    def test_valid(self):
        result_schedule_path = process_booking(GluSupplier.POLSAT, GluBookingQuality.OK, GluScheduleType.OK_4CHANNELS_CLEAR)
    ...
    def test_absent_channels_in_schedule(self):
        ...
        try:
            process_booking(GluSupplier.POLSAT, GluBookingQuality.ABSENT_CHANNELS, GluScheduleType.OK_4CHANNELS_CLEAR)
    ...
    def test_illegal_channels_in_booking(self):
        ...
        try:
            process_booking(GluSupplier.POLSAT, GluBookingQuality.ILLEGAL_CHANNELS, GluScheduleType.OK_4CHANNELS_CLEAR)
        except MergerException as e:
